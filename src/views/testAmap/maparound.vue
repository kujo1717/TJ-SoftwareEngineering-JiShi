    ...
    >
      <div v-if="dialogShow">
        <div class="searchBox">
          <div>
            ...
            ></el-input>
            <el-button type="primary" @click="initMapByInput">查询</el-button>
          </div>
          <div
          ...
          >
            ...
            >
              <el-card id="info-window">
                <div>
                  <p>{{ window.activity_id }}</p>
                  <p>{{ window.activity_id }}</p>
                  <el-button
                    type="text"
                    @click="ClickActDetail(window.activity_id)"
                    >查看详情00</el-button
                  >
                </div>
              </el-card>
      ...
      >
        ...
        <div>
          ...
          <el-button @click="GetActMarker" type="primary"
            >GetActMarker</el-button
          >
        </div>
      </div>
    </el-dialog>
