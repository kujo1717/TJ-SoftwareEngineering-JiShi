<template>
  <el-container style="border: 1px solid #eee">
    <el-tabs style="width: 100%" tab-position="right" v-model="index_tab" @tab-click="(tab) => IndexTabsClick(tab.name)">
            ...
            <div style="display: inline-block">
              <el-col style="width: 700px; padding-left: 20px">
                <el-card class="box-card" style="width: 100%">
                  <div slot="header" class="clearfix" style="text-align: center">
                    ...
                    <el-button style="margin-right: 20px" @click="
                        submitFun();
                        open();
                      ">搜索</el-button>
                      ...
                      <el-form :model="form" style="text-align: left">
                        <el-form-item label="活动标签" :label-width="formLabelWidth">
                          <el-checkbox-group v-model="checkboxGroup1">
                            <el-checkbox-button v-for="tag in tags" :key="tag.tagID" :label="tag">{{ tag.name }}</el-checkbox-button>
                          </el-checkbox-group>
                        </el-form-item>
                      </el-form>
                      <div style="padding-left: 50px">
                        已选择：
                        <el-tag v-for="tag in checkboxGroup1" :key="tag.tagID" :label="tag">{{ tag.name }}</el-tag>
                      </div>
                  ...
                  <div v-for="(list, index) in showData.slice((currentPage1 - 1) * pagesize1, currentPage1 * pagesize1)" :key="index">
                    <div style="display: inline-block; width: 800px">
                      ...
                      <div style="
                        ...
                        <p>
                          活动名称：{{ list.name }}
                          <el-button style="padding: 0 0 0 3em" type="text" @click="ClickActDetail(list.activity_id)">点击查看</el-button>
                        </p>
                        <!-- 活动配图展示 -->
                        <div class="images">
                          <el-image v-if="list.images" style="margin-right: 1em; height: 10em" :src="GetIllusImgUrl(list.images)">
                  ...
                  <el-pagination @size-change="handleSizeChange1" @current-change="handleCurrentChange1" :current-page="currentPage1" :page-sizes="[5, 10, 15, 20]" :page-size="pagesize1"
              ...
              <el-col style="width: 400px; padding-left: 50px">
                <el-card class="box-card" style="width: 100%">
                  ...
                  <el-table :data="tableData.slice((currentPage - 1) * pagesize, currentPage * pagesize)" style="width: 100%" :default-sort="{ prop: 'heat', order: 'descending' }">
