    ...
    <el-card class="intro-card-component">
      ...
      <div class="projmembers_box">
        ...
        <div class="pmb_members">
          <div class="pmb_member_item" v-for="(member, index) in member_datalist" :key="index">
      ...
      <el-dialog class="icc_adminMember_dialog" :v-if="isShow_dialog_adminAllMembers" :visible.sync="isShow_dialog_adminAllMembers">
        <span class="icc_adminMember_dashBoard">
          ...
          <div class="icca_memberline" v-for="(mem, index) in member_datalist" :key="index">
    ...
    async getActDetail(activity_id) {
      ...
      await getActDetail(activity_id, this.user_id)
        .then((res) => {
          ...
          this.newact_form.repeat = !!act_detail.repeat_interval
